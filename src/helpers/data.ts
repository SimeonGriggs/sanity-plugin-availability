...
export const dayKeysOfTheWeek: DayKey[] = [
  'monday',
  'tuesday',
  'wednesday',
  'thursday',
...
export const defaultAvailabilityTimes = (): AvailabilityTime[] => [
  {
...
export const defaultAvailabilityDays = (): AvailabilityDay[] =>
  daysOfTheWeek.map((day, dayIndex) => ({
    ...
    day,
    availableTimes: [`Sunday`, `Saturday`].includes(day) ? [] : defaultAvailabilityTimes(),
  }))
